...
public class IDEPathHelper {
    ...
    static {
        try {
            //Path projectRootDir = Paths.get(requireNonNull(IDEPathHelper.class.getResource("gatling.conf"), "Couldn't locate gatling/gatling.conf").toURI()).getParent().getParent().getParent().getParent().getParent().getParent().getParent();
            Path projectRootDir = Paths.get(requireNonNull(IDEPathHelper.class.getResource("/gatling/gatling.conf"), "Couldn't locate gatling/gatling.conf").toURI()).getParent().getParent().getParent().getParent();
